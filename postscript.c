...
void ps_preamble(file,dev, prog, pdx, pdy, llx, lly, urx, ury) 
FILE *file;
char *dev;
char *prog;
...
double llx, lly, urx, ury;  /* drawing bounding box in user coords */
{
    ...
    fprintf(fp,"/c2 {0.900 0.000 0.000 srgb} bind def\n");
    fprintf(fp,"/c3 {0.000 0.900 0.000 srgb} bind def\n");
    fprintf(fp,"/c4 {0.000 0.000 0.900 srgb} bind def\n");
    fprintf(fp,"/c5 {0.000 0.900 0.900 srgb} bind def\n");
    fprintf(fp,"/c6 {0.900 0.000 0.900 srgb} bind def\n");
    fprintf(fp,"/c7 {0.900 0.900 0.000 srgb} bind def\n");
    fprintf(fp,"/c8 {0.900 0.500 0.500 srgb} bind def\n");
    fprintf(fp,"/c9 {0.500 0.900 0.500 srgb} bind def\n");
    fprintf(fp,"/c10 {0.500 0.500 0.900 srgb} bind def\n");
    ...
    fprintf(fp,"/c14 {0.500 0.500 0.500 srgb} bind def\n");
    fprintf(fp,"/c15 {0.300 0.600 0.300 srgb} bind def\n");
    fprintf(fp,"/c16 {0.100 0.100 0.100 srgb} bind def\n");
    fprintf(fp,"end\n");
    fprintf(fp,"save\n");
    fprintf(fp,"newpath\n");
